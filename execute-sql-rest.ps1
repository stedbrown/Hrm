# Script per eseguire file SQL utilizzando la REST API di Supabase
...
# Funzione per eseguire una query SQL utilizzando la REST API
...
if ($SqlFile) {
    ...
    Write-Host "Esecuzione del file SQL $SqlFile utilizzando la REST API..."
    ...
    Write-Host "Utilizzo: .\execute-sql-rest.ps1 -SqlFile <nome_file_sql>"
    Write-Host "Esempio: .\execute-sql-rest.ps1 -SqlFile enable-rls.sql"
} 